...
import HeadPic from "./Photos/bev.jpg"
export default function Beverages() {
    ...
    const fetchFood = async () => {
        ...
        setFoodItems(data.filter((food) => food.cuisine == "Beverages"));
        setMainItems(data.filter((food) => food.cuisine == "Beverages"));
    };
    ...
    return (<div className="food-menu">
        <div className="Headbox">
            <img src={HeadPic} />
            <h3>Beverages for Every Mood!</h3>
        </div>
