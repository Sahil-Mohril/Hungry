...
import HeadPic from "./Photos/sweet.jpeg"
export default function NorthIndian() {
    ...
    const fetchFood = async () => {
        ...
        setFoodItems(data.filter((food) => food.cuisine == "Sweets"));
        setMainItems(data.filter((food) => food.cuisine == "Sweets"));
    };
    ...
    return (<div className="food-menu">
        <div className="Headbox">
            <img src={HeadPic} />
            <h3>Savor the Sweet<br></br> Side of Life!</h3>
        </div>
