...
import HeadPic from "./Photos/diet.jpeg"
...
export default function NorthIndian() {
    ...
    const fetchFood = async () => {
        ...
        setFoodItems(data.filter((food) => food.cuisine == "Diet"));
        setMainItems(data.filter((food) => food.cuisine == "Diet"));
    };
    ...
    return (<div className="food-menu">
        <div className="Headbox">
            <img src={HeadPic} />
            <h3>Healthy Bites,<br /> Happy Life!</h3>
        </div>
