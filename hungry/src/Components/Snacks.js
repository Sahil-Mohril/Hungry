...
import HeadPic from "./Photos/snacks.jpg"
export default function NorthIndian() {
    ...
    const fetchFood = async () => {
        ...
        setFoodItems(data.filter((food) => food.cuisine == "Snacks"));
        setMainItems(data.filter((food) => food.cuisine == "Snacks"));
    };
    ...
    return (<div className="food-menu">
        <div className="Headbox">
            <img src={HeadPic} />
            <h3>Little Bites,<br></br> Big Delight</h3>
        </div>
