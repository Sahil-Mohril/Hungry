...
import HeadPic from "./Photos/north.jpg"
export default function NorthIndian() {
    ...
    const fetchFood = async () => {
        ...
        setFoodItems(data.filter((food) => food.cuisine == "North Indian"));
        setMainItems(data.filter((food) => food.cuisine == "North Indian"));
    };
    ...
    return (<div className="food-menu">
        <div className="Headbox">
            <img src={HeadPic} />
            <h3>Explore the Taste of<br />North India</h3>
        </div>
