...
import HeadPic from "./Photos/south.jpg"
export default function NorthIndian() {
    ...
    const fetchFood = async () => {
        ...
        setFoodItems(data.filter((food) => food.cuisine == "South Indian"));
        setMainItems(data.filter((food) => food.cuisine == "South Indian"));
    };
    ...
    return (<div className="food-menu">
        <div className="Headbox">
            <img src={HeadPic} />
            <h3>Discover the Taste of<br />South India</h3>
        </div>
